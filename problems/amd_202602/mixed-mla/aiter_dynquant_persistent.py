...
#!POPCORN gpu MI355X
"""aiter dynamic_per_tensor_quant for fp8 Q (single kernel) + persistent mode."""
import torch
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if bs >= 64 and kvl >= 8192:
        ...
        qv = qi.view(-1, NUM_HEADS, QK_HEAD_DIM); ps, fm = 1, False
    else:
        qv = q.view(-1, NUM_HEADS, QK_HEAD_DIM); qs = None; ps, fm = 2, True
