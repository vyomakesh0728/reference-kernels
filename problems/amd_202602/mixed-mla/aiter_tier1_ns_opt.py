...
#!POPCORN gpu MI355X
"""Tier 1: optimized ns per shape. Lower splits for large to reduce launch overhead.
a16w8 for bs<=4 or kv<=1024. a8w8+dynquant for rest. Fewer splits than before."""
import torch
...
def _get_config(bs, kvl):
    ...
    if kvl <= 1024:
        ...
        if bs <= 4:  return (32, False, 2, True)    # a16w8 high splits
        if bs <= 32: return (8, True, 1, False)     # a8w8 ns=8
