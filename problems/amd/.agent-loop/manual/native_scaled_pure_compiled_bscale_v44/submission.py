...
CONFIG = {
    "variant_name": "native_scaled_pure_compiled_bscale_v44",
    "family": "hip_explore",
...
def _module():
    ...
    if _MODULE is None:
        ...
        _MODULE = load_inline(
            ...
            functions=["mxfp4_mm_hip", "mxfp4_mm_hip_mfma_medium", "mxfp4_mm_hip_mfma_scale_exact_m16", "mxfp4_mm_hip_mfma_scale_exact_m32", "mxfp4_pack_a_fixed", "mxfp4_repack_b_packed", "mxfp4_unshuffle_b_scale"],
