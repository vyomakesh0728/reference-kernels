...
CONFIG = {
    "variant_name": "native_scaled_m32_full_multiples32_v22_prodwrap",
    "family": "hip_explore",
...
SCALE_GROUP = 32
DIRECT_M32_EXPERIMENT = "REAL_A_REAL_SCALES_ROWMAJOR_B_LANE_SCALE_BYTE_FULL_M32_PRODWRAP"
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if a.shape[0] == 16 and (a.shape[1] % 128) == 0 and (b.shape[0] % 16) == 0:
        _phase("path_scaled_m16_bypassed")
