...
#!POPCORN gpu MI355X
# AGENT_LOOP_META: {"generator": {"kind": "manual_phase2"}, "gpu": "MI355X", "leaderboard": "amd-mxfp4-mm", "policy_profile": {"family": "hip_explore", "name": "hip_phase2_bf16_inputs"}, "problem": "mxfp4_mm"}
import hashlib
import os
...
CONFIG = {
    "variant_name": "hip_phase2_bf16_inputs",
    "family": "hip_explore",
...
def _get_b_contract(
    ...
    b_ref = (b_ref_vals * b_scale_f32).to(torch.bfloat16).contiguous()
...
def _reference_oracle_inputs(
    ...
    a_ref = (a_corrected_vals * a_scale_f32).to(torch.bfloat16).contiguous()
    return a_ref, b_ref
