...
#!POPCORN gpu MI355X
# AGENT_LOOP_META: {"generator": {"kind": "manual_phase2"}, "gpu": "MI355X", "leaderboard": "amd-mxfp4-mm", "policy_profile": {"family": "hip_explore", "name": "hip_phase2_vectorized_ingress"}, "problem": "mxfp4_mm"}
import hashlib
import os
...
CONFIG = {
    "variant_name": "hip_phase2_vectorized_ingress",
    "family": "hip_explore",
