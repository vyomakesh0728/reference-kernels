...
#!POPCORN gpu MI355X
# AGENT_LOOP_META: {"attempt": 15, "generator": {"kind": "manual_reference"}, "gpu": "MI355X", "leaderboard": "amd-mxfp4-mm", "policy_profile": {"family": "hip_explore", "name": "hip_reference_a_bcalibrated_bq_rawscale"}, "problem": "mxfp4_mm"}
import hashlib
import os
...
CONFIG = {
    "variant_name": "hip_reference_a_bcalibrated_bq_rawscale",
    "family": "hip_explore",
...
constexpr bool LDS_SWIZZLE = false;
constexpr bool USE_SCALE_MFMA_SEED = false;
constexpr bool REFERENCE_INPUTS = true;
constexpr bool NAIVE_KERNEL = false;
