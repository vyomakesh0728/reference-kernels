...
def default_manifest(workspace_root: Path) -> list[SourceSpec]:
    ...
    return [
        ...
        SourceSpec(
            id="tutel-readme",
            kind="git",
            repo="https://github.com/microsoft/tutel.git",
            ref="main",
            paths=["README.md"],
        ),
        SourceSpec(
            id="deepseek-v3-readme",
            kind="git",
            repo="https://github.com/deepseek-ai/DeepSeek-V3.git",
            ref="main",
            paths=["README.md"],
        ),
        SourceSpec(
            id="scattermoe-readme",
            kind="git",
            repo="https://github.com/shawntan/scattermoe.git",
            ref="main",
            paths=["README.md"],
        ),
        SourceSpec(
            id="flashmoe-readme",
            kind="git",
            repo="https://github.com/osayamenja/FlashMoE.git",
            ref="main",
            paths=["README.md"],
        ),
        SourceSpec(
            id="sonic-moe-readme",
            kind="git",
            repo="https://github.com/Dao-AILab/sonic-moe.git",
            ref="main",
            paths=["README.md"],
        ),
        SourceSpec(
